...
public class match_editor : EditorWindow {
	...
	public Texture2D gem_color_0;
	public Texture2D gem_color_1;
	public Texture2D gem_color_2;
	public Texture2D gem_color_3;
	public Texture2D gem_color_4;
	public Texture2D gem_color_5;
	public Texture2D gem_color_6;
	...
	void OnEnable()
		...
		gem_random = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/3match/editor_icons/gem_random",typeof(Texture2D)) ;
		gem_color_0 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/3match/editor_icons/gem_color_0",typeof(Texture2D)) ;
		gem_color_1 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/3match/editor_icons/gem_color_1",typeof(Texture2D)) ;
		gem_color_2 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/3match/editor_icons/gem_color_2",typeof(Texture2D)) ;
		gem_color_3 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/3match/editor_icons/gem_color_3",typeof(Texture2D)) ;
		gem_color_4 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/3match/editor_icons/gem_color_4",typeof(Texture2D)) ;
		gem_color_5 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/3match/editor_icons/gem_color_5",typeof(Texture2D)) ;
		gem_color_6 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/3match/editor_icons/gem_color_6",typeof(Texture2D)) ;
	...
	void Show_tile(int x, int y)
	{
		...
		if (board_array[x,y,0] <= -1)
			...
			if (board_array[x,y,1] == 0)
                ...
                else if (board_array[x, y, 4] == 8)
                    GUI.Label(new Rect(x * size_button, y * size_button, size_button, size_button), bonus_time);
                else if (board_array[x, y, 4] == 9)
                    GUI.Label(new Rect(x * size_button, y * size_button, size_button, size_button), bonus_moves);
                else if (board_array[x, y, 4] == 10)
                    GUI.Label(new Rect(x * size_button, y * size_button, size_button, size_button), bonus_heal);
