...
public class explosion_fx : MonoBehaviour {
	...
	public ExplosionGarbage my_garbage;
    public Transform my_garbage_transform;
	...
	public void Activate_me(ExplosionGarbage garbage) //call this the the first time, when tile create the fx
		{
		my_garbage = garbage;
    ...
    {
        my_garbage_transform = garbage;
        Invoke("Go_to_garbage", go_to_garbage_after_n_seconds);
    }

    void Go_to_garbage()
		{
		transform.parent = my_garbage.transform;
        my_garbage.GoBack(this);
		}
